...
'''
#4.7晚上22:53修改:增加cs参数的打印，将最优块的选择个数从cma_mu(重名参数)改为block_mu
(1)epsilon = 0.22,block_size = 16,num_test_classes = 20,lambda_sparsity = 0.3,self.sparsity(初始块内稀疏度) = 0.1 
42.40% Loss=-23.4174
🔥GPU攻击进程: 100%|████████████████████████████| 5/5 [00:20<00:00,  4.18s/it, Current_Acc=42.40%, Global_Acc=42.40%, Loss=-23.4174]
攻击进度: 100%|██████████████████████████████████████████████████████████████████| 200/200 [1:34:17<00:00, 28.29s/it, Success=51.0%]

最终攻击成功率: 51.0%
平均L0扰动: 69.2, 平均L1扰动: 31.3

(2)epsilon = 0.22,block_size = 8,num_test_classes = 20,lambda_sparsity = 0.3，self.sparsity(初始块内稀疏度) = 0.1 
🔥GPU攻击进程: 100%|█████████████████████████████████████████████████████| 5/5 [00:11<00:00,  2.31s/it, Current_Acc=54.90%, Global_Acc=55.30%, Loss=-6.7411]
攻击进度: 100%|██████████████████████████████████████████████████████████████████████████████████████████████| 20/20 [05:16<00:00, 15.83s/it, Success=55.0%]

最终攻击成功率: 55.0%
平均L0扰动: 17.2, 平均L1扰动: 7.6

(3)epsilon = 0.22,block_size = 32,num_test_classes = 20,lambda_sparsity = 0.3，self.sparsity(初始块内稀疏度) = 0.1 
🔥GPU攻击进程: 100%|█████████████████████████████████████████████████████| 5/5 [00:11<00:00,  2.33s/it, Current_Acc=55.30%, Global_Acc=55.20%, Loss=-7.0151]
攻击进度: 100%|██████████████████████████████████████████████████████████████████████████████████████████████| 20/20 [05:04<00:00, 15.21s/it, Success=50.0%]

最终攻击成功率: 50.0%
平均L0扰动: 17.7, 平均L1扰动: 7.5

(4)epsilon = 0.25,block_size = 32,num_test_classes = 20,lambda_sparsity = 0.3，self.sparsity(初始块内稀疏度) = 0.1 
极其慢，效果并没有加强
=56.12%, Loss=-112.3973]
攻击进度:   5%|████▌                                                                                      | 1/20 [53:01<16:47:28, 3181.51s/it, Success=0.0%]
🔥GPU攻击进程:  20%|██████████                                        | 1/5 [08:53<35:35, 533.80s/it, Current_Acc=54.90%, Global_Acc


(5)epsilon = 0.25,block_size = 16,num_test_classes = 20,lambda_sparsity = 0.3，self.sparsity(初始块内稀疏度) = 0.1 
last_Current_Acc=46.10%,Global_Acc=46.50%,Loss=-28.3630
最终攻击成功率55.0%，平均L0扰动：68.7，平均L1扰动：31.4


(6)epsilon = 0.25,block_size = 8,num_test_classes = 20,lambda_sparsity = 0.3，self.sparsity(初始块内稀疏度) = 0.1 
last_Current_Acc=54.80%,Global_Acc=54.56%,Loss=-7.0232
最终攻击成功率50%，平均L0扰动：17.4，平均L1扰动：7.6

(7)epsilon = 0.25,block_size = 8,num_samples = 16,其他的和(6)一样
🔥GPU攻击进程: 100%|█████████████████████| 5/5 [00:38<00:00,  7.71s/it, Current_Acc=54.60%, Global_Acc=54.44%, Loss=-37.0666]
攻击进度: 100%|███████████████████████████████████████████████████████████████| 20/20 [13:00<00:00, 39.04s/it, Success=55.0%]

最终攻击成功率: 55.0%
平均L0扰动: 17.4, 平均L1扰动: 8.1

(9):(7)在200类测试,每类迭代10轮(先做的是这个实验),num_samples = 16
攻击进度: 100%|█████████████████████████████████████████████████████████████████████████████████████████▌| 199/200 [3:57:28<00:55, 5🔥GPU攻击进程: 100%|██████████████████████████| 10/10 [00:19<00:00,  1.98s/it, Current_Acc=40.20%, Global_Acc=40.46%, Loss=-31.3723]
攻击进度: 100%|█████████████████████████████████████████████████████████████████████████████████████████▌| 199/200 [3:58:13<00:55, 5攻击进度: 100%|██████████████████████████████████████████████████████████████████████████████████████████| 200/200 [3:58:13<00:00, 5攻击进度: 100%|██████████████████████████████████████████████████████████████████████████████████████████| 200/200 [3:58:13<00:00, 71.47s/it, Success=50.5%]

最终攻击成功率: 50.5%
平均L0扰动: 17.6, 平均L1扰动: 7.9

(8):(7)在200类的测试,每类迭代十轮，num_samples = 8
🔥GPU攻击进程: 100%|███████████████████| 10/10 [00:40<00:00,  4.09s/it, Current_Acc=41.10%, Global_Acc=41.40%, Loss=-13.3087]
攻击进度: 100%|███████████████████████████████████████████████████████████| 200/200 [3:51:50<00:00, 69.55s/it, Success=50.0%]

(10) .(9)(8)基础上测试,num_samples = 12
🔥GPU攻击进程: 100%|█| 10/10 [00:18<00:00,  1.82s/it, Current_Acc=41.50%, Global_Acc=41.53%, Loss=-22.3159]
攻击进度: 100%|█| 200/200 [2:01:49<00:00, 36.55s/it, Success=50.0%]

最终攻击成功率: 50.0%
平均L0扰动: 17.5, 平均L1扰动: 7.9
最终攻击成功率: 50.0%
平均L0扰动: 17.7, 平均L1扰动: 7.8
...
# self.cmu = 0.25  # 取消临时值
        ...
        # 上面这行公式出处:E‖N(0,I)‖ ≈ √n * [1 - 1/(4n) + 1/(21n²)]

        #这是为了块内稀疏(进而体现为整体稀疏)而引入的
        # 新增稀疏性参数
        self.sparsity = 0.3             # 初始稀疏度（扰动前10%的像素）
    ...
    def update(self, all_samples, fitness_values): #传进来的时候，all_samples是list，fitness_values是所有样本的适应度np.array。这个函数的bug应该是调完了
        ...
        self.cs_history.append(self.cs)
        # print(f"c1: {self.c1}")
...
class SZOAttack:
    ...
    def update_prob(self, blocks, fitness_values):
        ...
        # ================= 1. 更新块选择概率 =================
        # 统计成功块（按适应度排序选择前mu个样本的块）
        sorted_indices = np.argsort(fitness_values)[-self.mu:]  # 取适应度最高的mu个样本
        success_blocks = blocks_np[sorted_indices]
        unique_blocks, counts = np.unique(success_blocks, return_counts=True)
        counts = torch.from_numpy(counts).float().to(self.prob.device)

        # 更新概率（非线性加权）
        new_prob = self.prob * 0.9
        new_prob[unique_blocks] += (counts ** 1.5) * 0.1  # 指数加权
        self.prob = new_prob / new_prob.sum()
        
        # 添加平滑因子防止零概率
        self.prob = (self.prob + 0.01) / (self.prob.sum() + 0.01 * len(self.prob))
        
        # ================= 2. 执行CMA-ES更新 =================
        for bid in unique_blocks:
            mask = (blocks_np == bid)
            block_samples = self.cma_blocks[bid].sample()  # 直接获取已存储的样本
            block_fitness = fitness_values[mask]
            
            # 确保样本维度正确 [n_samples, dim]
            ...
            # print("sample_array.dtypr",samples_array.dtype)
            # print("fitness_values.dtype",fitness_values.dtype)
        ...
        for bid in unique_blocks:
            ...
            if cma.best_fitness < global_best:
                cma.sparsity = min(cma.sparsity * 1.1, 0.5)  # 增加稀疏度
            else:
                cma.sparsity = max(cma.sparsity * 0.9, 0.05)  # 降低稀疏度
...
class AttackVisualizer:
    ...
    #     plt.close()
    def print_cma_es(self, cid, bid, cma_state, iteration):
        ...
        with open(save_path, 'w') as f:
            f.write("Iteration, c1, cmu, cs, ||p_sigma||, ||p_c||, sigma\n") #这里的第一个值不是iteration,是被第几次选中
            for i, (c1, cmu, cs, p_sigma, p_c, C, sigma) in enumerate(zip(
                    param_history['c1'], param_history['cmu'], param_history['cs'],
                ...
                f.write(f"{i}, {c1}, {cmu},{cs}, {p_sigma}, {p_c}, {sigma}, {C}\n")
